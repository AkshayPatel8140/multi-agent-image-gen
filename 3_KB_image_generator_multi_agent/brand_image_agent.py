...
def image_node(state: State) -> Command[Literal["compose_node"]]:
    ...
    return Command(
        update={"messages": state["messages"] + [AIMessage(content=f"[BASE_IMAGE] {base_path}", name="image_generator")]},
        goto="compose_node",
    )
...
if __name__ == "__main__":
    ...
    for event in graph.stream(state, stream_mode="values"):
        ...
        if step_count == 1:
            print("\n🤖 Agent 1: Loading brand guidelines...")
        elif step_count == 2:
            print("\n🤖 Agent 2: Engineering brand-aware prompt...")
        elif step_count == 3:
            print("\n🤖 Agent 3: Generating base image...")
        elif step_count == 4:
            print("\n🤖 Agent 4: Compositing logo...")
