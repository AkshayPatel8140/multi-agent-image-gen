...
*Watch the two-agent system in action! This demo shows the VS Code interface with the image generation workflow, demonstrating how the prompt engineer and image generator agents collaborate to create stunning images.*
